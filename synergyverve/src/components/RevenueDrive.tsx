    ...
    <div className="bg-text   min-h-screen p-8 flex items-center justify-center">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative mt-12 h-screen">
          ...
          <div
            className="bg-secondary  rounded-lg p-8 shadow-lg border border w-full md:w-92 absolute  left-[-30%] z-40"
          >
            <h3 className="text-accent text-4xl font-bold mb-4">
              Bring More Visitors to Your Website
            </h3>

            <ul className="text-text text-lg mb-8 space-y-2">
          ...
          <div
            className="bg-secondary rounded-lg p-8 shadow-lg border  w-full md:w-92 absolute top-[200px] left-[30%] z-40"
          >
          ...
          <div
            className="bg-secondary rounded-lg p-8 shadow-lg border border-gray-600 w-full md:w-92 absolute  top-[420px] left-[-30%] z-40"
          >
            <h3 className="text-accent text-4xl font-bold mb-4 ">
          ...
          <div
            className=" bg-secondary rounded-lg p-8 shadow-lg border border-gray-600 w-full md:w-92 absolute top-[620px] left-[30%] z-40"
          >
            <h3 className="text-accent text-4xl font-bold mb-4  text-right">
