  ...
  const services = [
    ...
    },
    {
      ...
      subcategories: [
        ...
        { name: "Training & Workshops", link: "/services/complianceAudits" },
      ],
    },
  ];
        ...
        <div className="hidden md:block relative">
          <ul className="flex space-x-6">
            <li className="relative group">
              ...
              <div className="absolute left-0 mt-3 w-auto bg-black text-white shadow-lg rounded-md p-6 grid grid-cols-3 gap-6 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
