...
import cds from "../../../../public/servicesImg/cds.webp";
...
const CloudDataSolutions: React.FC = () => {
  const data = [
    {
  ...
  const serviceSections = [
    {
      tagText: "Cloud Migration",
      title: " A Strategic Approach to Scalable Growth",
      description: [
        " Migrating to the cloud is essential for businesses aiming to enhance scalability, flexibility, and cost efficiency. Our cloud migration services ensure a seamless transition to AWS, Azure, and Google Cloud, minimizing disruptions while optimizing performance and security. A well-structured cloud migration strategy ensures business growth, security, and long-term efficiency.",
      ...
      benefits: [
        {
          title: "Scalability",
          description:
            "Dynamically adjust resources based on business demand",
        },
        {
          title: "Cost Savings",
          description:
            "Reduce capital expenses by eliminating on-premise hardware.",
        },
        {
          title: "Business Continuity",
          description:
            "Cloud-based disaster recovery ensures data availability.",
        },
        {
          title: "Flexibility & Innovation",
          description:
            "Use cloud-native tools to optimize operations",
        },
        {
          title: "Security & Compliance",
          description:
            "Advanced encryption and access controls protect sensitive data.",
        },
      ],
    },
    {
  ...
  return (
    <>
      ...
      <AuroraBackground className="bg-secondary rounded-lg">
        ...
        >
          <div className="text-3xl max-w-6xl md:text-7xl font-bold dark:text-white text-center">
            Scalable Cloud Data Solutions for Seamless Growth
          </div>
          <div className="text-center font-semibold text-base max-w-5xl md:text-lg dark:text-neutral-200 py-4">
            Unlock the power of cloud data solutions to achieve unmatched
            scalability, flexibility, and cost efficiency. Businesses today rely
            on cloud platforms like AWS, Azure, and Google Cloud to easily
            store, manage, and process vast amounts of data. Our agency, Synergy
            Verve, understands the transformative potential of cloud technology
            and how it can redefine your data strategy, ensuring optimal
            performance and streamlined operations. Let’s explore how scalable
            cloud solutions can drive efficiency and innovation for your
            business.
          </div>
          <EmailBar />
        </motion.div>
      ...
      <TransformSection
        ...
        imageAlt="Cloud Data"
        tagText="Cloud Data"
        title="Synergy Verve’s Cloud Data Solutions"
        ...
        description2="●	Cloud Migration  ●	Data Warehousing ●	Cloud Security"
        description3="●	Cloud Management
●	Data Analytics
